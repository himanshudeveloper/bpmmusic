...
String _$albumHash() => r'e1622cdee88a2bbc43159d72345ea232fc89915e';
...
/// See also [album].
class AlbumFamily extends Family<AsyncValue<AlbumModel>> {
  /// See also [album].
  const AlbumFamily();
...
/// See also [album].
class AlbumProvider extends AutoDisposeFutureProvider<AlbumModel> {
  /// See also [album].
  AlbumProvider({
    required String id,
  }) : this._internal(
  ...
  Override overrideWith(
    FutureOr<AlbumModel> Function(AlbumRef provider) create,
  ) {
...
mixin AlbumRef on AutoDisposeFutureProviderRef<AlbumModel> {
  /// The parameter `id` of this provider.
  String get id;
}

class _AlbumProviderElement extends AutoDisposeFutureProviderElement<AlbumModel>
    with AlbumRef {
