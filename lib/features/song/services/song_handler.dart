...
//     // musicKit.onPlayerQueueChanged.listen((data) {
//     //   print("jdjjdjjdjdj2");
//     //   // data.currentEntry
//     //   //  SongNotifier().currentSong(data.currentEntry!);
//     //   // d
//     // });
//   }
...
//   Future<void> initSongs({required List<Map<String, dynamic>> songs}) async {
...
//     // himanshu
//     await musicKit.setQueueWithItems("songs", items: songs);
...
//   @override
//   Future<void> play() => musicKit.play();
//   //audioPlayer.play();

//   // Pause function to pause playback
//   @override
//   Future<void> pause() => musicKit.pause();
//   //audioPlayer.pause();

//   // Seek function to change the playback position
//   @override
//   Future<void> seek(Duration position) => musicKit.beginSeekingForward();
